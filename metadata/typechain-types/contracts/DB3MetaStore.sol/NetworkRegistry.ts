...
export declare namespace NetworkRegistry {
...
export interface NetworkRegistryInterface extends utils.Interface {
  functions: {
...
export interface NetworkRegistry extends BaseContract {
  ...
  functions: {
    getAllNetworkRegistrations(
      ...
      [NetworkRegistry.NetworkRegistrationStructOutput[]] & {
        registrations: NetworkRegistry.NetworkRegistrationStructOutput[];
      }
    >;
  ...
  getAllNetworkRegistrations(
    ...
    pageSize: PromiseOrValue<BigNumberish>,
    overrides?: CallOverrides
  ): Promise<NetworkRegistry.NetworkRegistrationStructOutput[]>;
