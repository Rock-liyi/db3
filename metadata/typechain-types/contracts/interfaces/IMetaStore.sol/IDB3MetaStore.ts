...
export interface IDB3MetaStoreInterface extends utils.Interface {
  functions: {
    ...
    "registerNetwork(uint64,string,string[])": FunctionFragment;
    "registerRollupNode(uint64,string)": FunctionFragment;
    "updateRollupNode(uint64,string)": FunctionFragment;
  };
...
export interface IDB3MetaStore extends BaseContract {
  ...
  functions: {
    getAllNetworkRegistrations(
      ...
      [IDB3MetaStore.NetworkRegistrationStructOutput[]] & {
        registrations: IDB3MetaStore.NetworkRegistrationStructOutput[];
      }
    >;
